...
const PricingCard = ({
  ...
  const handlePlanSelect = () => {
    ...
    if (title.toLowerCase().includes('mensal')) {
      ...
      pixCodeValue = '00020126440014br.gov.bcb.pix0114547777530001370204DUOP520400005303986540554.995802BR5916GPR ANALISE LTDA6008BRASILIA62170513CLIENTEMENSAL63045711';
